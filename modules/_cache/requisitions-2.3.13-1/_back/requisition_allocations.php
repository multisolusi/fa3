...
supplier_list_row(_("Supplier : "), 'supplier_id', $_POST['supplier_id'], true, false);
...
echo "<div align='center'><a href='requisition_allocations.php?po=yes'>Generate Purchase Order</a></div>\n";
//------------------------------------------------------------------------------------
