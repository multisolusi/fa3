...
$discount_bertingkat=lihat_discount_bertingkat($myrow["DebtorName"]);
label_row("Discount : $discount_bertingkat ");
...
if (db_num_rows($result) > 0)
{
	...
	while ($myrow2 = db_fetch($result))
	{
	    ...
	    else
	    {
			...
			// $display_discount = lihat_discount_bertingkat();
			   $display_discount = round($myrow2["unit_price"]*$myrow2["quantity"]*$myrow2["discount_percent"]);
	    }
