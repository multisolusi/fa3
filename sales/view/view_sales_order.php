...
function lihat_discount_bertingkat()
{
$pelanggan=$_SESSION['View']->customer_name;
...
$discount_bertingkat=lihat_discount_bertingkat($_SESSION['View']->customer_name);
label_row(_("Discount"), $discount_bertingkat, "class='tableheader2'", "colspan=3");
...
foreach ($_SESSION['View']->line_items as $stock_item) {
	...
	// lihat discount bertingkat :
	$jml_discount=$stock_item->quantity*$stock_item->price*$stock_item->discount_percent;
	amount_cell("$jml_discount");
