	...
	class renderer
	{
		function get_icon($category)
		{
			...
			if ($show_menu_category_icons)
				...
				$img = 'right.gif';
			return "<img src='$path_to_root/themes/anterp/images/$img' style='vertical-align:middle;' border='0'>&nbsp;&nbsp;";
		}
		...
		function menu_header($title, $no_menu, $is_index)
		{
			...
			if (!$no_menu)
			{
				...
				$img = "<img src='$local_path_to_root/themes/anterp/images/login.gif' width='14' height='14' border='0' alt='"._('Logout')."'>&nbsp;&nbsp;";
				$himg = "<img src='$local_path_to_root/themes/anterp/images/help.gif' width='14' height='14' border='0' alt='"._('Help')."'>&nbsp;&nbsp;";
